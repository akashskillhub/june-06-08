...
const Details = () => {
    ...
    return <>
        <section class="text-gray-600 body-font overflow-hidden p-10">
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2  ">
                    <div className='flex flex-col md:flex-row gap-2 items-start'>
                        ...
                        <img alt="ecommerce" class="order-1 md:order-2  flex-1 md:w-4/5 object-cover object-center rounded" src={images[index]} />
                    </div>
                    <div class="  w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div class="flex">
                            ...
                            <button class="flex ml-auto  btn">Add To Cart</button>
